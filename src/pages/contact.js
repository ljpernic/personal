    ...
    return (
      <Layout page={"contact"}>
        ...
        <div className="contact-grid-container">
          ...
          <div className="contact-grid-item">filler@filler.com</div>
          <div className="contact-grid-item">1-xxx-xxx-xxxx</div>
          <div className="contact-grid-item">@LeonPerniciaro</div>
        </div>
      </Layout>
    )
  }
