...
async function sourceNodes({
  ...
  const previousForeignReferenceMapState = await cache.get(CACHE_FOREIGN_REFERENCE_MAP_STATE); // Build foreign reference map before starting to insert any nodes
